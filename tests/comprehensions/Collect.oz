...
define
   local
      ...
      L3a = thread [1:collect:C1 2:collect:C2 for lazy A in 1..2 body {C1 A}{C2 A+1}] end
      L3b = thread [1:collect:C1 2:collect:C2 for lazy A in 1..2 body {C1 A}{C2 A+1}] end
      ...
      L6a = thread [1:collect:C1 2:collect:C2 for lazy A in 1..2 for B in 3..4 body {C1 A}{C2 B}] end
      L6b = thread [1:collect:C1 2:collect:C2 for lazy A in 1..2 for B in 3..4 body {C1 A}{C2 B}] end
      L7a = thread [1:collect:C1 2:collect:C2 for lazy A in 1..2 for lazy B in 3..4 body {C1 A}{C2 B}] end
      L7b = thread [1:collect:C1 2:collect:C2 for lazy A in 1..2 for lazy B in 3..4 body {C1 A}{C2 B}] end
      TestsLazy = [ %%
                    L1.c#[1 2]#1
                    L2.c#[1 2 2 3]#2
                    L3a.1#[1 2]#1
