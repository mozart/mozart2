...
TEST_F(ByteStringTest, Get) {
  ...
  EXPECT_RAISE(MOZART_STR("indexOutOfBound"), ByteStringLike(b).bsGet(vm, 2, result));
  EXPECT_RAISE(MOZART_STR("indexOutOfBound"), ByteStringLike(b).bsGet(vm, -1, result));
...
TEST_F(ByteStringTest, Slice) {
  ...
  UnstableNode result;
  EXPECT_RAISE(MOZART_STR("indexOutOfBound"), ByteStringLike(b).bsSlice(vm, -1, 0, result));
  EXPECT_RAISE(MOZART_STR("indexOutOfBound"), ByteStringLike(b).bsSlice(vm, 5, 6, result));
  EXPECT_RAISE(MOZART_STR("indexOutOfBound"), ByteStringLike(b).bsSlice(vm, 3, 2, result));
...
TEST_F(ByteStringTest, StrChr) {
  ...
  UnstableNode result;
  EXPECT_RAISE(MOZART_STR("indexOutOfBound"), ByteStringLike(b).bsStrChr(vm, -1, '2', result));
  EXPECT_RAISE(MOZART_STR("indexOutOfBound"), ByteStringLike(b).bsStrChr(vm, 6, '2', result));
